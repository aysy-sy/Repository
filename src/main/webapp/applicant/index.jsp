...
<body>
	...
	<div class="dvheader">
		<div class="dvheadertools">
			<span class="headerspantitle">管理员,您好</span><a href="WelcomeFirst.jsp">退出</a>
			<ul class="headerultools">
				<li class="headerlitools_info headerlitools"
					...
					</div> 管理员<i style="margin-left: 8px;" class="icon-caret-down"></i>
	...
	<div class="dvcontent">
		...
		<ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
			...
			<li class="limenuitem"><i class="icon-cog menuicon"></i>操作菜单<b
				...
				<ul class="ulleftsubitems">
					<%--<a href="/OrderManagementSystem/TypeServlet?action=schType&type=${type.type_id}"
						target="right">
						<li>分类管理</li>
					</a>--%>
					<%--<a href="/OrderManagementSystem/ProServlet?action=schPro&itemId=${item.id}"
						target="right">
						<li>产品管理</li>
					</a>--%>
						<a href="product.jsp?currPage=1"
						   target="right">
							<li>产品管理</li>
						</a>
					<a href="../applicant/addNew.jsp"
					   target="right">
						<li>产品添加</li>
					</a>
					<%--<a href="/OrderManagementSystem/ProServlet?action=schFlowerPurchaseRecord" target="right">
						<li>进货管理</li>
					</a>--%>
						<%--<a href="/OrderManagementSystem/ProServlet?action=schProSalesRecord" target="right">
							<li>订单管理</li>
						</a>--%>
					<%--<a href="/OrderManagementSystem/ProServlet?action=schProSalesRecord2&currPage=1" target="right">
						<li>订单管理</li>
					</a>--%>
						<a href="admin_order.jsp?currPage=1" target="right">
							<li>订单管理</li>
						</a>
					<a href="Personal-Admin.jsp" target="right">
						<li>个人中心</li>
					</a>
		...
		<div style="position: absolute; left: 191px; right: 20px;">
			<iframe src="welcome.jsp" scrolling="no" width="100%" height="1200" overfolw:auto
